...
const headerObserver = new IntersectionObserver(stickyNav, { rootMargin: `-${navHeight}px` });
...
const imgTargets = section1.querySelectorAll('img');
...
// Functions
  ...
  const prevSlide = function() {
    ...
    curSlide = (curSlide - 1) % slides.length;
    if (curSlide < 0) curSlide = mod(curSlide, slides.length);
    goToSlide(curSlide);
    activateDot(curSlide);
  };
